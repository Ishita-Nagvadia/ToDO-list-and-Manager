...
<body style="background-color: #f7f7f7 !important">
		...
		<nav class="navi navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
			<div class="collapse navbar-collapse align-items-start">
				...
				<ul class="navbar-nav nav justify-content-end nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" style="color: black;" href="meetings.php">Meetings</a>
					</li>
					<li class="nav-item">
	...
	<div class="container-fluid" style="background-color: #f7f7f7;">
		<div class="d-flex main card">
			<div class="card-header" style="width: 100%"><b>Meetings</b>
			...
			<div class="card-body" style="width:100%">
				<table id="myTable" class="table table-striped responsive display cell-border">
					...
					<?php
						...
						$query = "SELECT * FROM meeting WHERE uid='$sid'"; 
					...
					?>
						<tr>
							<td><?php echo '<a href="showmeeting.php?mid='.$row["mid"].'">'.$row["title"].'</a>'?></td>
							...
							<?php 
									...
									$newformat1 = date('h:i a',$time1);
							?>
							<td><?php echo $newformat1;?></td>
							<td><?php echo $row["description"];?></td>
							<!-- <td>
								<button type="button" class="btn btn-outline-success btn-sm" tooltip="Edit"><i class="bi bi-pencil"></i></i></button>
								<button type="button" class="btn btn-outline-danger btn-sm" tooltip="Delete"><i class="bi bi-trash"></i></button>
							</td> -->
						</tr>
						<?php
								$i++;
